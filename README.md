...
Hidden Messages is an approximate 1,000 line python project using Motif Discovery, Laplace's Law of Succession, and Gibbs Sampling to identify recognisable DNA sequences within small microbial genomes, such as the oriC of *E. coli*. It also visualises these regions on skew diagrams.
